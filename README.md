...
这是一个把 `Agent 主循环 + 工具系统 + 记忆系统 + RAG + 上下文工程` 串起来、并且尽量保持代码路径清楚的学习型仓库。

## 首页先看什么

- 想先知道项目结构：看 `docs/architecture.md`
- 想先看 Agent 怎么实现：看 `docs/agents.md`
- 想先看记忆和 RAG：看 `docs/memory.md`
- 想先看工具系统：看 `docs/tools.md`
- 想先直接跑示例：看“快速开始”和“运行”

## 这个仓库有什么亮点

- 不只讲概念，是真的把 Agent 主流程手写出来
- 同时包含 `ReAct / Plan-and-Solve / Reflection` 三种范式
- 工具系统、记忆系统、RAG、上下文工程是连起来的，不是分散的样例
- 支持原生 `tool calling`，也保留了更容易学习的文本版链路
- 当前 `P0` 已收完，已经可以作为阶段性最终版阅读和参考
